...
class ConditionTests: XCTestCase {
	...
	func runCondition7(_ json: FHIRJSON? = nil) throws -> SwiftFHIR.Condition {
		let inst = (nil != json) ? instantiateFrom(json: json!) : try instantiateFrom(filename: "condition-example2.json")
		...
		XCTAssertEqual(inst.onsetDateTime?.description, "2012-11-12")
		XCTAssertEqual(inst.patient?.reference, "Patient/example")

...
class NutritionOrderTests: XCTestCase {
	...
	func runNutritionOrder4(_ json: FHIRJSON? = nil) throws -> SwiftFHIR.NutritionOrder {
		let inst = (nil != json) ? instantiateFrom(json: json!) : try instantiateFrom(filename: "nutritionorder-example-texture-modified.json")
	...
	func runNutritionOrder9(_ json: FHIRJSON? = nil) throws -> SwiftFHIR.NutritionOrder {
		let inst = (nil != json) ? instantiateFrom(json: json!) : try instantiateFrom(filename: "nutritionorder-example-pureeddiet.json")
